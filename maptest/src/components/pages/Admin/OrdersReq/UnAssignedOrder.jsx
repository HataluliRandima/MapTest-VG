  ...
  return (
    <div className="bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1
     shadow-lg shadow-slate-500">
      <h1 className="text-gray-700 font-bold text-lg text-center underline items-center">ALL ORDERS </h1>
      <h1 className="text-gray-700 font-medium text-lg     ">Order Details </h1>
