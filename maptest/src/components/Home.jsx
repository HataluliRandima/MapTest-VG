  ...
  >
    <div className="grid md:grid-cols-2 max-w-screen-xl m-auto px-3">
      <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
        ...
        /> */}
        <button className="border bg-black text-white border-white hover:bg-black hover:text-white rounded-md duration-300 ease-out capitalize py-3 px-6 sm:w-8/12 my-8" onClick={()=> setShowModal(true)}>Become Driver</button>
      </div>
